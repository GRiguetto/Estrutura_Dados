...
public class TestesArrayAlunos {
    ...
    public void realizaTestes(Scanner teclado) {
        ...
        for( int i = 0 ; i < alunos.length ; i++ ){
            ...
            //instanciar o objeto Aluno, tranferindo os dados para o contrutor
        ...
        alunos[2].setNome("Nicole de Sousa Constantino");
        alunos[2].setRA("1234567");
        alunos[2].setCurso("Farmacia");
